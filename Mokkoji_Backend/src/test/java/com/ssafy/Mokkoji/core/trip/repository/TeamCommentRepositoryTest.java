...
class TeamCommentRepositoryTest {
    ...
    void findAll() {
        ...
        // when
        List<TeamCommentSpecification> result = teamCommentRepository.getAllTeamCommentByBoardId(board.getTeamBoardId());
    ...
    void isNotCommentWriter() {
        ...
        // when, then
        assertThat(teamCommentRepository.isTeamCommentWriter(otherUser.getUserId(), comment.getTeamCommentId())).isFalse();
    }
}