<template>
  ...
  import TeamBoardListItem from "@/components/tripPlan/team/board/TeamBoardListItem.vue";
  ...
  export default {
    ...
    created() {
      api.get(`/enjoytrip/TripTeam/${this.tripTeamId}/boards`).then(({ data }) => {
        this.articles = data;
      });
    ...
    methods: {
      moveWrite() {
        this.$router.push({ name: "teamBoardRegister" });
      },
